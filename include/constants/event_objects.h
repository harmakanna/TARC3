...
enum
{
    ...
    OBJ_EVENT_GFX_DIGITAL_SOPHIE,
    OBJ_EVENT_GFX_ERNEST_OUTSIDE,
    OBJ_EVENT_GFX_HARRIET_OUTSIDE,
    OBJ_EVENT_GFX_MINH_OUTSIDE,
    OBJ_EVENT_GFX_ERNEST_VR,
    OBJ_EVENT_GFX_HARRIET_VR,
    OBJ_EVENT_GFX_MINH_VR,
    OBJ_EVENT_GFX_KUMATORA,
    OBJ_EVENT_GFX_IDOL_PINK,
    OBJ_EVENT_GFX_IDOL_YELLOW,
    OBJ_EVENT_GFX_IDOL_BLUE,
    OBJ_EVENT_GFX_OFFICER_M,
    OBJ_EVENT_GFX_OFFICER_F,
    OBJ_EVENT_GFX_CREDITS_AGB1,
    OBJ_EVENT_GFX_CREDITS_AGB2,
    OBJ_EVENT_GFX_CREDITS_AND,
    OBJ_EVENT_GFX_CREDITS_JAMIE1,
    OBJ_EVENT_GFX_CREDITS_JAMIE2,
    OBJ_EVENT_GFX_CREDITS_JAMIE3,
    OBJ_EVENT_GFX_CREDITS_KUMA1,
    OBJ_EVENT_GFX_CREDITS_KUMA2,
    OBJ_EVENT_GFX_CREDITS_KUMA3,
    OBJ_EVENT_GFX_CREDITS_KUMA4,
    OBJ_EVENT_GFX_CREDITS_FOLD1,
    OBJ_EVENT_GFX_CREDITS_FOLD2,
    OBJ_EVENT_GFX_CREDITS_FOLD3,
    OBJ_EVENT_GFX_CREDITS_FOLD4,
...
#define OBJ_EVENT_PAL_TAG_DIGITAL_SOPHIE          0x1134
#define OBJ_EVENT_PAL_TAG_ERNEST_OUTSIDE          0x1135
#define OBJ_EVENT_PAL_TAG_HARRIET_OUTSIDE         0x1136
#define OBJ_EVENT_PAL_TAG_MINH_OUTSIDE            0x1137
...
#define OBJ_EVENT_PAL_TAG_KUMATORA                0x113C
#define OBJ_EVENT_PAL_TAG_IDOL_PINK                0x113D
#define OBJ_EVENT_PAL_TAG_IDOL_YELLOW                0x113E
#define OBJ_EVENT_PAL_TAG_IDOL_BLUE                0x113F
#define OBJ_EVENT_PAL_TAG_FAIRY_TALE_GIRL         0x1140
#define OBJ_EVENT_PAL_TAG_OFFICER_M                0x1141
#define OBJ_EVENT_PAL_TAG_OFFICER_F                0x1142
#define OBJ_EVENT_PAL_TAG_CUSTOM_CREDITS            0x1143
