...
#define PHONE_OFFSCREEN_Y                   (UseFlipPhone() ? 96 : 98)
...
#define FACE_ICON_COMFY_SPRING_TENSION      50
#define FACE_ICON_COMFY_SPRING_FRICTION     300
...
static void RotomPhone_OverworldMenu_UpdateSprites(u32 selected);
...
static bool32 RotomPhone_StartMenu_UnlockedFunc_ExitVR(void);
...
static const u8 * const sRotomPhoneAds[] = {
    COMPOUND_STRING("Have a BETTER day!"),
    COMPOUND_STRING("Don't worry, be BETTER!"),
    COMPOUND_STRING("In here, it's BETTER!"),
    COMPOUND_STRING("The Place that makes you feel BETTER!"),
    COMPOUND_STRING("Report - ExeggCutie skin missing egg"),
    COMPOUND_STRING("Report - What Idols really want"),
    COMPOUND_STRING("Report - Secret phrases for your Idol"),
    COMPOUND_STRING("Report - The best chairs and sofas"),
    COMPOUND_STRING("Report - Modern home decorating"),
    COMPOUND_STRING("Report - Antique skin maintenance"),
    COMPOUND_STRING("Report - Historical furniture styles"),
    COMPOUND_STRING("You're cute; wanna be cuter? BETTER makeup!"),
    COMPOUND_STRING("BETTER furniture, for a BETTER rest!"),
    COMPOUND_STRING("txt FEEDBACK to fill out a short survey!"),
    COMPOUND_STRING("txt SELL DATA to fill out a short survey!"),
    COMPOUND_STRING("txt STOP to show slightly fewer messages"),
    COMPOUND_STRING("txt REPORT if you see illegal activity!"),
    COMPOUND_STRING("txt HI BABY to chat with Idols!"),
    COMPOUND_STRING("txt LONELY to chat with Idols!"),
    COMPOUND_STRING("txt FRIENDS to chat with Idols!"),
    COMPOUND_STRING("txt HEY GIRL to chat with Idols!"),
    COMPOUND_STRING("txt GIRLFRIEND to chat with Idols!"),
    COMPOUND_STRING("txt MISS ME to chat with Idols!"),
    COMPOUND_STRING("txt BLACKJACK to reserve a table!"),
    COMPOUND_STRING("txt ROULETTE to reserve a table!"),
    COMPOUND_STRING("txt CARDS to reserve a table!"),
    COMPOUND_STRING("txt POOL to reserve a table!"),
    COMPOUND_STRING("txt POKER to reserve a table!"),
    COMPOUND_STRING("txt SLOTS to see current odds!"),
    COMPOUND_STRING("txt LOTTERY to see current odds!"),
    COMPOUND_STRING("txt CHAIR to browse furniture!"),
    COMPOUND_STRING("txt SOFA to browse furniture!"),
    COMPOUND_STRING("txt COUCH to browse furniture!"),
    COMPOUND_STRING("txt STOOL to browse furniture!"),
    COMPOUND_STRING("txt OTTOMAN to browse furniture!"),
    COMPOUND_STRING("txt DESK to browse furniture!"),
    COMPOUND_STRING("txt BEANBAG to browse furniture!"),
    COMPOUND_STRING("txt RECLINER to browse furniture!"),
    COMPOUND_STRING("txt LOVESEAT to browse furniture!"),
    COMPOUND_STRING("txt TABLE to browse furniture!"),
    COMPOUND_STRING("txt EASY CHAIR to browse furniture!"),
    COMPOUND_STRING("txt BED to browse furniture!"),
    COMPOUND_STRING("Have you had a hot cocoa today?"),
    COMPOUND_STRING("txt BETTER ADS to get personalized ads!"),
    COMPOUND_STRING("txt NO ADS for a premium subscription!"),
    COMPOUND_STRING("Sofas, stools, and beanbags, a block away!"),
    COMPOUND_STRING("Want to sell your ideas? Advertise here!"),
    COMPOUND_STRING("Opt out of data collection? Press Y now"),
    COMPOUND_STRING("Congrats on your 1463-day Place streak!"),
    COMPOUND_STRING("The Topsy Turvy gacha has begun!"),
    COMPOUND_STRING("Topsy Turvy Blissey has 255 Speed!"),
    COMPOUND_STRING("Topsy Turvy Electrode has 150 HP!"),
    COMPOUND_STRING("Topsy Turvy Eiscue becomes defensive!"),
    COMPOUND_STRING("Topsy Turvy Sylveon is adorable!"),
    COMPOUND_STRING("New Purebred IRL Pokemon available!"),
    COMPOUND_STRING("Flabubus now available in Superstore!"),
    COMPOUND_STRING("New Stunky Pops released today!"),
    COMPOUND_STRING("A BETTER Place - No microplastics!"),
    COMPOUND_STRING("A BETTER Place - No roommates!"),
    COMPOUND_STRING("A BETTER Place - Connect with nature!"),
    COMPOUND_STRING("A BETTER Place - Make new friends!"),
    COMPOUND_STRING("A BETTER Place - Skins don't gain weight!"),
    COMPOUND_STRING("A BETTER Place - Choose your body!"),
    COMPOUND_STRING("A BETTER Place - Work is steps away!"),
    COMPOUND_STRING("A BETTER Place - Perfect hygiene!"),
    COMPOUND_STRING("A BETTER Place - Your own private space!"),
    COMPOUND_STRING("A BETTER Place - Pokemon everywhere!"),
    COMPOUND_STRING("A BETTER Place - No limits gaming!"),
    COMPOUND_STRING("A BETTER Place - Clean atmosphere!"),
    COMPOUND_STRING("A BETTER Place - Full of colors!"),
    COMPOUND_STRING("A BETTER Place - Rent anything!"),
    COMPOUND_STRING("Rotom Phone - Access your PC anywhere!"),
    COMPOUND_STRING("Rotom Phone - Helpful messages 24/7!"),
    COMPOUND_STRING("Rotom Phone - View your Pokemon!"),
    COMPOUND_STRING("Rotom Phone - Speed up Battles!"),
    COMPOUND_STRING("Rotom Phone - Change your UI!"),
    COMPOUND_STRING("Rotom Phone - Return to a worse world!"),
    COMPOUND_STRING("Rotom Phone - Manage your credits!"),
    COMPOUND_STRING("Rotom Phone - No bag required!"),
    COMPOUND_STRING("Rare skins at the BETTER Superstore!")
};
...
#else
    if (UseFlipPhone() || (RP_CONFIG_MONOCHROME_ICONS && palSlot < PAL_ICON_WHITE))
...
static bool32 RotomPhone_DisabledFunction(void)
{
    return FALSE;
}
...
static const struct RotomPhone_MenuOptions sRotomPhoneOptions[RP_MENU_COUNT] =
{
    ...
    [RP_MENU_QUESTS] =
    {
        ...
        .rotomSpeech = COMPOUND_STRING("to see quests?"),
    ...
    [RP_MENU_EXIT_VR] =
    {
        .menuName = COMPOUND_STRING("Exit VR"),
        .rotomSpeech = COMPOUND_STRING("to exit VR?"),
    ...
    [RP_MENU_BATTLE_SIM] =
    {
        .menuName = COMPOUND_STRING("Battle Sim"),
...
static void RotomPhone_OverworldMenu_Init(bool32 firstInit)
{
    ...
    if (!UseFlipPhone() && RP_CONFIG_UPDATE_MESSAGE_SOUND)
...
static void RotomPhone_OverworldMenu_LoadIconSpritePalette(bool32 firstLoad)
{
    ...
    if (firstLoad)
    {
        ...
        if (UseFlipPhone() || RP_CONFIG_MONOCHROME_ICONS)
        {
...
static void RotomPhone_OverworldMenu_CreateAllIconSprites(void)
{
    u32 optionSlot = 0;
    u32 optionCurrent = 0;
    for (u32 menuId = 0; menuId < RP_MENU_COUNT; menuId++)
    {
    ...
    for (; optionSlot < RP_OW_OPTION_COUNT; optionSlot++)
    {
        sRotomPhone_StartMenu->menuOverworldOptions[optionSlot] = RP_MENU_COUNT;
    }
    ...
    RotomPhone_OverworldMenu_UpdateSprites(optionCurrent);
}
...
static void RotomPhone_OverworldMenu_CheckUpdateMessage(u8 taskId)
{
    if (!tRotomUpdateTimer && !UseFlipPhone())
    {
...
static void RotomPhone_OverworldMenu_UpdateSprites(u32 selected)
{
    ...
    s32 iconRow = 0;
    for (u32 i = 0; i < RP_OW_OPTION_COUNT; i++)
    {
        if (sRotomPhone_StartMenu->menuOverworldOptions[i] == RP_MENU_COUNT)
            return;
        if (selected >= maxRows * 2)
        {
            iconRow = i / 2 + (maxRows - 1) - selected / 2;
        }
        else
        {
            iconRow = i / 2;
        }
        if (iconRow < 0 || iconRow >= maxRows)
        {
            gSprites[sRotomPhone_StartMenu->menuOverworldIconSpriteId[i]].invisible = TRUE;
        }
        else
        {
            gSprites[sRotomPhone_StartMenu->menuOverworldIconSpriteId[i]].invisible = FALSE;
            gSprites[sRotomPhone_StartMenu->menuOverworldIconSpriteId[i]].y = y + (iconRow * yAdd);
        }
    }
}
...
static void RotomPhone_OverworldMenu_HandleDPAD(u8 taskId)
{
    ...
    else if (sRotomPhone_StartMenu->menuOverworldOptions[optionCurrent + 2] == RP_MENU_COUNT && optionCurrent % 2 == 1)
        offset = 1;
    else
        offset = 2;
    ...
    RotomPhone_OverworldMenu_UpdateSprites(nextIndex);
    RotomPhone_OverworldMenu_UpdateMenuPrompt(taskId);
}

static u32 GetEasingComfyAnim_CurrentFrame(struct ComfyAnim *comfy)
{
    return  comfy->state.easingState.curFrame;
}
...
static void RotomPhone_StartMenu_CreateRotomFaceSprite(bool32 rotomFade)
{
    if (UseFlipPhone() || sRotomPhone_StartMenu->menuRotomFaceSpriteId != SPRITE_NONE)
        return;
