...
static const struct CreditsEntry sCreditsEntryTable[] =
{
    ...
    CREDITS_NORMAL("Silph City by Ekat HeartlessDragoon, Morlockhater, Nemu, Ross Hawkins,"),
    CREDITS_NORMAL("Pokemon Dawn, Slimshady, Thedeadheroalistar, The-Red-Ex, Vurtax and Zein"),
    CREDITS_NORMAL("Dark City by J-Treecko252"),
    CREDITS_NORMAL("Fountain by Kyledove and Speed"),
    CREDITS_NORMAL("Battle Platform by KingTapir"),
    CREDITS_NORMAL("Hotel Interior by Ekat, Vurtax, Heartless Dragoon, Halcyon Team"),
    CREDITS_TITLE("Overworld Sprites:"),
    CREDITS_NORMAL("Leaf by kwenio"),
    CREDITS_NORMAL("Kumatora rip from Mother 3 by Solink"),
    CREDITS_NORMAL("Fairy Tale Girl from Mother 3 by kyle dove and ulithium dragon"),
    CREDITS_NORMAL("Officer by ryuujiryu"),
    CREDITS_TITLE("Trainer Sprites:"),
    CREDITS_NORMAL("Leaf by kwenio"),
    CREDITS_NORMAL("Idol by Rubire4"),
    CREDITS_NORMAL("Officer by Pawkkie and Project Palladium Team"),
    ...
    CREDITS_NORMAL("Virtual City sprite templates by Coffee Cup"),
    CREDITS_SCROLL(180),
    CREDITS_END,
};
