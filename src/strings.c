...
const u8 gText_SideQuestName_Ledian[] = _("BRING BACK LEDIAN!!!");
const u8 gText_SideQuestName_Tea[] = _("Uncivilized Buffoons");
const u8 gText_SideQuestName_Contentment[] = _("DisconTENTment");
const u8 gText_SideQuestName_Baby[] = _("fight baby");
...
const u8 gText_SideQuestDoneDesc_Ledian[] = _("Hmmph…\nNobody appreciates Ledian like I do…");
const u8 gText_SideQuestDoneDesc_Tea[] = _("Haha! That will teach that\ncretin to disparage tea!");
const u8 gText_SideQuestDoneDesc_Contentment[] = _("Put that Pokemon in the PC,\nand let's never speak of it.");
const u8 gText_SideQuestDoneDesc_Baby[] = _("ur baby");
const u8 gText_SideQuestDoneDesc_8[] = _("Completed Quest 6");
const u8 gText_SideQuestDoneDesc_9[] = _("Completed Quest 7");
...
const u8 gText_SideQuestMapLedian[] = _("BETTER Nature Refuge");
const u8 gText_SideQuestMapTea[] = _("BETTER Hotel Lobby");
const u8 gText_SideQuestMapContentment[] = _("BETTER Stadium");
const u8 gText_SideQuestMapBaby[] = _("BETTER Stadium");
