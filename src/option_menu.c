...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tBattleSpeed = VarGet(VAR_TARC_SPEEDUP) >> 1;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    VarSet(VAR_TARC_SPEEDUP, gTasks[taskId].tBattleSpeed << 1);
...
static const u8 gText_BattleSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1X");
static const u8 gText_BattleSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2X");
static const u8 gText_BattleSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}4X");
...
static void BattleSpeed_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleSpeedSlow, 104, YPOS_BATTLESPEED, styles[0]);

    widthSlow = GetStringWidth(FONT_NORMAL, gText_BattleSpeedSlow, 0);
    widthMid = GetStringWidth(FONT_NORMAL, gText_BattleSpeedMid, 0);
    widthFast = GetStringWidth(FONT_NORMAL, gText_BattleSpeedFast, 0);

    widthMid -= 94;
    xMid = (widthSlow - widthMid - widthFast) / 2 + 104;
    DrawOptionMenuChoice(gText_BattleSpeedMid, xMid, YPOS_BATTLESPEED, styles[1]);

    DrawOptionMenuChoice(gText_BattleSpeedFast, GetStringRightAlignXOffset(FONT_NORMAL, gText_BattleSpeedFast, 198), YPOS_BATTLESPEED, styles[2]);
}
