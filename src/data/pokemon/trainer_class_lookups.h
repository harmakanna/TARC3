const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_IDOL_PINK] = TRAINER_PIC_IDOL_PINK,
    [FACILITY_CLASS_IDOL_YELLOW] = TRAINER_PIC_IDOL_YELLOW,
    [FACILITY_CLASS_IDOL_BLUE] = TRAINER_PIC_IDOL_BLUE,
    [FACILITY_CLASS_OFFICER_M] = TRAINER_PIC_OFFICER_M,
    [FACILITY_CLASS_OFFICER_F] = TRAINER_PIC_OFFICER_F,
...
{
    [FACILITY_CLASS_IDOL_PINK] = TRAINER_CLASS_IDOL,
    [FACILITY_CLASS_IDOL_YELLOW] = TRAINER_CLASS_IDOL,
    [FACILITY_CLASS_IDOL_BLUE] = TRAINER_CLASS_IDOL,
    [FACILITY_CLASS_OFFICER_M] = TRAINER_CLASS_OFFICER_M,
    [FACILITY_CLASS_OFFICER_F] = TRAINER_CLASS_OFFICER_F,
