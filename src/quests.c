...
{
	side_quest(
	      gText_SideQuestName_Prologue,
	      gText_SideQuestDesc_Prologue,
	      gText_SideQuestDoneDesc_Prologue,
	      gText_SideQuestMapPrologue,
	      OBJ_EVENT_GFX_LUCY,
	      OBJECT,
	      NULL,
	      0
	...
	side_quest(
	      gText_SideQuestName_ActI,
	      gText_SideQuestDesc_ActI,
	      gText_SideQuestDoneDesc_ActI,
	      gText_SideQuestMapActI,
	      OBJ_EVENT_GFX_MINH_OUTSIDE,
	      OBJECT,
	      NULL,
	      0
	),
	side_quest(
	      gText_SideQuestName_ActII,
	      gText_SideQuestDesc_ActII,
	      gText_SideQuestDoneDesc_ActII,
	      gText_SideQuestMapActII,
	      OBJ_EVENT_GFX_HARRIET_OUTSIDE,
	      OBJECT,
	      NULL,
	      0
	),
	side_quest(
	      gText_SideQuestName_ActIII,
	      gText_SideQuestDesc_ActIII,
	      gText_SideQuestDoneDesc_ActIII,
	      gText_SideQuestMapActIII,
	      OBJ_EVENT_GFX_ERNEST_OUTSIDE,
	      OBJECT,
	      NULL,
	      0
	),
	...
	side_quest(
	      ...
	      gText_SideQuestDesc_Ledian,
	      gText_SideQuestDoneDesc_Ledian,
	      gText_SideQuestMapLedian,
	      OBJ_EVENT_GFX_SPECIES(LEDIAN),
	      OBJECT,
	      NULL,
	      0
	),
